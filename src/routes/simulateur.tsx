      ...
      <main className="flex-1 py-12">
        <div className="max-w-[800px] mx-auto px-4">
          ...
          <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-4">
            ...
            <Link to="/evaluation" className="w-full md:w-auto px-12 h-14 bg-primary text-on-primary font-bold rounded-lg hover:opacity-90 transition-all flex items-center justify-center shadow-lg active:scale-95">
              Continuer
