...
/**
 * ATTENTION : FALLBACK_JOURNEYS est une liste de secours statique (backup) utilisée
 * exclusivement en cas de panne réseau ou de problème d'accès à la table `formation_offers`.
 * La source unique de vérité absolue pour les offres de formation est la table de base de données.
 */
